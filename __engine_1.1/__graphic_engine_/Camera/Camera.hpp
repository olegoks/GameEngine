...
public:
	...
	void RotateCamera(const float alpha_deegree, const Vector3D& around_vector, const Vertex3D& around_point)noexcept(true);
	...
	inline void SetPosition(const float x, const float y, const float z)noexcept(true) {
